...
import { PrimarySchema } from "../../components/schemas/schemas";

const PrimaryContent = () => {
  const pageTitle = "Primary ";
  ...
  const fetchRecords = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch Primary records", error);
  ...
  const handlePost = async (formData) => {
    try {
      const docRef = await addDoc(collection(db, "primary"), formData);
  ...
  const handleUpdate = async (formData) => {
    ...
    try {
      const docRef = doc(db, "primary", formData.id);
  ...
  const handleDelete = async () => {
    try {
      const docRef = doc(db, "primary", deleteId);
